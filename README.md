...
В версии для win уже установлены, нужно только разкоментировать.
...
# Соглашения
В компонентах ОС данные пеедаюся только поссылкам на переменные, с верхнеего компанената до нижнего.
